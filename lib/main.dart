...
class _ProductListState extends State<ProductList> {
  List<Product> products = [
    ...
    Product(name: "Product 3", price: 0.9),
    ...
    Product(name: "Product 10", price: 0.5),
    Product(name: "Product 11", price: 16),
    Product(name: "Product 12", price: 17),
    Product(name: "Product 13", price: 18),
    Product(name: "Product 14", price: 19),
    Product(name: "Product 15", price: 2.5),
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return ListTile(
            title: Text(products[index].name, style: TextStyle(color: Colors.brown),),
              ...
              onBuyPressed: (product) {
                if (product.counter == 5) {
                  showDialog(
                    ...
                    builder: (context) {
                      return AlertDialog(
                        title: Text('Congratulations!',style: TextStyle(color: Colors.brown),),
